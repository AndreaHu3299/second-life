...
- **THEN** they can upload 3 to 6 photos through the new app upload flow
- **AND** photos can be reordered via drag-and-drop or explicit move controls
...
- **WHEN** the app loads for the first time with no user-generated data or while seeded demo mode is active
